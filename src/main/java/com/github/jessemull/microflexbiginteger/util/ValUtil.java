...
public class ValUtil {
     ...
     */
    public static void validatePlateBigInteger(Plate plate1, Plate plate2) {
     ...
     */
    public static void validatePlateBigInteger(Plate plate1, Collection<Plate> collection) {
     ...
     */
    public static void validatePlateBigInteger(Plate plate1, Plate[] array) {
     ...
     * @param    Plate    the second plate
     */
    public static void validatePlateBigInteger(int rows, int columns, Plate plate) {
     ...
     * @param    Collection<PlateBigInteger>    the plate collection
     */
    public static void validatePlateBigInteger(int row, int column, Collection<Plate> collection) {
     ...
     * @param    PlateBigInteger[]    the plate array
     */
    public static void validatePlateBigInteger(int row, int column, Plate[] array) {
