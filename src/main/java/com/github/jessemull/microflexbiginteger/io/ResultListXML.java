...
public class ResultListXML implements Iterable<ResultXML>{
     ...
     */
    public ResultListXML(Map<Well, BigInteger> map) {
     ...
     */
    public ResultListXML(Map<Well, BigInteger> map, String label) {
     ...
     */
    public ResultListXML(Collection<Map<Well, BigInteger>> collection) {
    	
    	int index = 1;
    	
        for(Map<Well, BigInteger> map : collection) {
     ...
     */
    public ResultListXML(Collection<Map<Well, BigInteger>> collection, List<String> labels) {
