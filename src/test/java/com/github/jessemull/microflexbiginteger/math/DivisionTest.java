...
import com.github.jessemull.microflexbiginteger.math.Division;
...
public class DivisionTest {
	...
	public static void setUp() {
    	...
    	for(int i = 0; i < stackNumber; i++) {
    		...
    		for(Plate plate1 : stack1) {
	    		for(Well well : plate1) {				
    		...
    		for(Plate plate2 : stack2) {
				for(Well well : plate2) {
					if(well.contains(BigInteger.ZERO)) {
						Collections.replaceAll(well.data(), BigInteger.ZERO, BigInteger.ONE);
					}
				}
			...
			for(Plate plateUneven : stackUneven) {
				for(Well well : plateUneven) {
					if(well.contains(BigInteger.ZERO)) {
						Collections.replaceAll(well.data(), BigInteger.ZERO, BigInteger.ONE);
					}
				}
    ...
    public void testPlateConstant() {
    	...
    	for(int i = 0; i < plates1.length; i++) {
    		...
    		Plate returnedPlate = division.plates(plate1, randomBigInteger);
    ...
    public void testSetConstant() {
    	...
    	for(int i = 0; i < plates1.length; i++) {
    		...
    		WellSet returned = division.sets(set, randomBigInteger);
    ...
    public void testStackConstant() {
    	...
    	for(int k = 0; k < stacks1.size(); k++) {
	    	...
	    	Stack returned = division.stacks(stack1, randomBigInteger);
