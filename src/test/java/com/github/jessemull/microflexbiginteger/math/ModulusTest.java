...
import com.github.jessemull.microflexbiginteger.math.Modulus;
...
/* ---------------------------- Local fields ---------------------------- */
    ...
    public void testPlateConstant() {
    	...
    	for(int i = 0; i < plates1.length; i++) {
    		...
    		Plate returnedPlate = modulus.plates(plate1, randomBigInteger);
    ...
    public void testSetConstant() {
    	...
    	for(int i = 0; i < plates1.length; i++) {
    		...
    		WellSet returned = modulus.sets(set, randomBigInteger);
    ...
    public void testStackConstant() {
    	...
    	for(int k = 0; k < stacks1.size(); k++) {
	    	...
	    	Stack returned = modulus.stacks(stack1, randomBigInteger);
