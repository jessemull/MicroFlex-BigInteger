...
import com.github.jessemull.microflexbiginteger.math.RightShift;
...
public class RightShiftTest {
	...
	private static RightShift shift = new RightShift();
	...
	public static void setUp() {
    	...
    	for(int i = 0; i < stackNumber; i++) {
    		...
    		Stack stack1 = RandomUtil.randomStackBigInteger(rows, columns, minValue, maxValue, length, "Plate" + i, plateNumber);
